    ...
    <div className="grid gap-4 lg:grid-cols-2">
      ...
      <form onSubmit={retry} className="grid gap-3 rounded-md border border-stone-200 bg-white p-4">
        ...
        {failedNotifications.length > 0 ? (
          ...
          <div className="rounded-md border border-dashed border-stone-300 bg-stone-50 px-3 py-2 text-sm text-stone-600">
            Немає email-повідомлень, які завершились помилкою.
          </div>
        )}
