      ...
      <form onSubmit={saveSettings} className="grid gap-3 rounded-md border border-stone-200 bg-white p-4">
        ...
        <label className="grid gap-1 text-sm">
          ...
          <input
            ...
            max={14}
          />
          <span className="grid gap-1 rounded-md border border-stone-200 bg-stone-50 px-3 py-2 text-xs text-stone-700">
            <span>
              0 днів: без додаткового часу. Якщо період закінчився і чергування не закрите, scheduler одразу переносить наступне чергування на ту саму людину.
            </span>
            <span>
              1+ днів: після кінця періоду чергування входить у Grace period. Черговий ще може поставити галочки і завершити прибирання, а наступний період чекає і не активується.
            </span>
            <span>
              Якщо під час grace все завершили і прийняли, графік іде далі нормально. Якщо grace минув, період стає Прострочено, а наступне чергування лишається за тією самою людиною.
            </span>
          </span>
        </label>
        {scheduleLocked ? <ScheduleLockedNotice /> : null}
